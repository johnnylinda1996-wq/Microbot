...
public class FishingSkillHandler implements SkillHandler {
    ...
    private static final List<FishingSpot> FISHING_SPOTS = Arrays.asList(
            ...
            new FishingSpot("Barbarian Village", 20, Arrays.asList("trout", "salmon"), Arrays.asList(1526, 1527, 1528), new WorldPoint(3104, 3433, 0), BankLocation.DRAYNOR_VILLAGE, Arrays.asList("Lure")),
            ...
            new FishingSpot("Tai Bwo Wannai", 65, Arrays.asList("karambwan"), Arrays.asList(4712), new WorldPoint(2780, 3178, 0), BankLocation.CATHERBY, Arrays.asList("Karambwanji")),
            ...
            new FishingSpot("Living Rock Caverns", 85, Arrays.asList("cavefish", "rocktail"), Arrays.asList(6825), new WorldPoint(3652, 5123, 0), BankLocation.DWARF_MINE_BANK, Arrays.asList("Bait"))
    );
